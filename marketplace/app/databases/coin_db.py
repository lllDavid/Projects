...
def insert_coin(coin: Coin, coin_specifications: CoinSpecifications, coin_market_data: CoinMarketData):
    ...
    # Insert the basic coin information
    ...
    coin_id = cursor.lastrowid  # Get the id of the newly inserted coin
    
    # Insert the coin specifications
