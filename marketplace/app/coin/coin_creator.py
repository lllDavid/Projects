...
class CoinCreator:
    ...
    def create_coin(self, name:str, symbol:str, category:str, description:str, price:float):
          return Coin(
            name=name, 
            symbol=symbol, 
            category=category,
        ...
        return Coin(coin=coin, coin_specs=coin_specs, coin_market_data=coin_market_data)
